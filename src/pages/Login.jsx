  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        <motion.form action="submit">
          ...
          >
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 rounded-lg bg-white/10 text-white border border-white/20 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition shadow-inner"
            />
          ...
          >
            <motion.button
              ...
              className="w-full py-2 bg-cyan-600 hover:bg-cyan-600 text-white font-bold text-lg rounded-lg shadow-[0_0_20px_rgba(34,211,238,0.4)] transition"
            >
              Login Securely
            </motion.button>
          </motion.div>
        ...
        {/* Divider b/w login and biometric Login */}
        ...
        {/* This is where the trust thingy shows up */}
        <motion.div
          initial={{ y: -30, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
