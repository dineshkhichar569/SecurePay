...
const SignUp = () => {
  const inputData = [
    { label: "Full Name", type: "text", placeholder: "Sunny" },
    {
      label: "Student Email",
      type: "email",
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute -bottom-10 -right-10 w-72 h-72 bg-purple-500 opacity-20 rounded-full blur-[100px] animate-pulse"></div>
      </div>

      {/* Main container about  Register an account*/}
      <motion.div
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.6 }}
        className="relative z-10 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 overflow-hidden bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl shadow-[0_0_30px_rgba(255,255,255,0.1)]"
      >

        {/* Left side of comtainer */}
        <motion.div
        ...
        >
          ...
          <p className="text-gray-300 text-sm">
            Join the new era of secure, AI-powered student payments. Our
            fraud-proof system keeps your transactions clean and traceable.
          </p>
          ...
          <form className="space-y-4">
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.5 }}
                type="submit"
                className="w-full bg-cyan-500 hover:bg-cyan-600 transition-all rounded-lg p-2 font-semibold text-black mt-1 shadow-lg cursor-pointer"
              >
                Register
              </motion.button>
            </motion.div>
